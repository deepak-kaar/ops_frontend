...
@Component({
  selector: 'app-manage-reportimage-new',
  standalone: false,
  templateUrl: './manage-reportimage-new.component.html',
  styleUrl: './manage-reportimage-new.component.css'
})
export class ManageReportimageNewComponent extends ReportimageAdministrationNewComponent implements OnInit, OnDestroy {
