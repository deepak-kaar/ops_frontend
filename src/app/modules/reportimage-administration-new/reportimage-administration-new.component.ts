...
import { ReportimageAdministrationService } from './services/reportimage-administration-new.service';
...
@Component({
  selector: 'app-reportimage-administration-new',
  standalone: false,
  template: '',
  styles: []
})
export class ReportimageAdministrationNewComponent implements OnInit {
