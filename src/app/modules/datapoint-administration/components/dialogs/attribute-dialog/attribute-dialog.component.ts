...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, FormsModule, SelectModule, ButtonModule, CheckboxModule, MultiSelectModule, TableModule, ToastModule, TextareaModule, InputTextModule],
...
export class AttributeDialogComponent {
  ...
  tabs = [
    { label: 'Basic Details', value: 0 },
    { label: 'Data Validation', value: 1 },
    { label: 'Default', value: 2 },
    { label: 'Data Source', value: 3 },
    { label: 'Display Component', value: 4 }
  ];
  ...
  ngOnInit() {
    if (this.dialogConfig.data) {
      ...
      const attr = this.dialogConfig.data.attributeValue || {};
      this.attributeForm.patchValue(attr);
  ...
  getDisplayComp() {
    this.datapointAdminService.getTemplateList({ templateType: 'Display Component' }).subscribe({
      next: (res: any) => {
        ...
        this.displayComponents.push(
          { id: 1, "type": "standard", "name": "Input Text" },
          { id: 2, "type": "standard", "name": "Dropdown" },
          { id: 3, "type": "standard", "name": "Radio Button" },
          { id: 4, "type": "standard", "name": "Checkbox" },
          { id: 5, "type": "standard", "name": "Button" },
          { id: 6, "type": "standard", "name": "Icon Button" },
          { id: 7, "type": "standard", "name": "Label" },
          { id: 8, "type": "standard", "name": "Paragraph" },
          { id: 9, "type": "standard", "name": "Dynamic Table" },
          { id: 10, "type": "standard", "name": "Static Table" },
          { id: 11, "type": "standard", "name": "Image" },
          { id: 12, "type": "standard", "name": "Video" },
          { id: 13, "type": "standard", "name": "Map" },
          { id: 14, "type": "standard", "name": "Tag" },
          { id: 15, "type": "standard", "name": "Date Tag" },
          { id: 16, "type": "standard", "name": "Location Tag" },
          { id: 17, "type": "standard", "name": "Divider" },
          { id: 18, "type": "standard", "name": "Guage" },
          { id: 19, "type": "standard", "name": "Pie Chart" },
          { id: 20, "type": "standard", "name": "Donut Chart" },
          { id: 21, "type": "standard", "name": "Polar" },
          { id: 22, "type": "standard", "name": "Radar" },
          { id: 23, "type": "standard", "name": "Bar Chart" },
          { id: 24, "type": "standard", "name": "Line" },
          { id: 25, "type": "standard", "name": "Hbar" },
          { id: 26, "type": "standard", "name": "Svbar" },
          { id: 27, "type": "standard", "name": "Shbar" },
        );
      },
      error: (err) => {
        console.log(err);
  ...
  getAttributes(entityId: string) {
    ...
    this.datapointAdminService.getEntityDetailsById(entityId).subscribe({
      next: (res: any) => {
        ...
        this.attributes = res.attributes.map((item: any) => ({
      ...
      error: (err) => {
        ...
        // Handle specific 404
        if (err.status === 404) {
          console.warn('Entity not found (404)');
          this.attributes = []; // reset gracefully
        }
      }
    });
  }
