...
@Component({
  selector: 'app-entity-datas-edit-form-new',
  standalone: false,
  templateUrl: './entity-datas-edit-form-new.component.html',
  styleUrl: './entity-datas-edit-form-new.component.css'
})
export class EntityDatasEditFormNewComponent {
