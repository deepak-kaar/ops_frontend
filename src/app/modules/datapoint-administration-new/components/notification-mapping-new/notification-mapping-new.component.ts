...
import { ManageNotificationsMappingsNewComponent } from 'src/app/modules/datapoint-administration-new/pages/notifications/manage-notifications-mappings-new/manage-notifications-mappings-new.component';
import { breakPointForToastComponent } from 'src/app/core/utils/breakpoint-utils';

@Component({
  selector: 'app-notification-mapping-new',
  standalone: false,
  templateUrl: './notification-mapping-new.component.html',
  styleUrl: './notification-mapping-new.component.css'
})
export class NotificationMappingNewComponent {
@Input() app: any;
  @Input() org: any;
  @Input() flagData: any;
 ...
 */
  ...
  createFlag() {
    this.ref = this.dialogService.open(ManageNotificationsMappingsNewComponent, {
      modal: true,
      closable: true,
