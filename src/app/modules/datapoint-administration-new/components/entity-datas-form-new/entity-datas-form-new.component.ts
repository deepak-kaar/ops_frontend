...
@Component({
  selector: 'app-entity-datas-form-new',
  standalone: false,
  templateUrl: './entity-datas-form-new.component.html',
  styleUrl: './entity-datas-form-new.component.css'
})
export class EntityDatasFormNewComponent {
 selectedCity: any;
