...
@Component({
  selector: 'app-manage-notifications-mappings-new',
  standalone: false,
  templateUrl: './manage-notifications-mappings-new.component.html',
  styleUrl: './manage-notifications-mappings-new.component.css'
})
export class ManageNotificationsMappingsNewComponent {
