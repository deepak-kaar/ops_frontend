...
@Component({
  selector: 'app-calculation-engine-home-v2',
  standalone: false,
  templateUrl: './calculation-engine-home-v2.component.html',
  styleUrl: './calculation-engine-home-v2.component.css'
})
export class CalculationEngineHomeV2Component implements OnInit {
